                    ...
                    <div class="col-lg-3 col-md-6">
                        <div class="card h-100 border-0 shadow-sm hover-effect">
                            <div class="card-body text-center p-4">
                                ...
                                <p class="text-muted">Profesionales con don de gentes y pasión por el mundo del motor
                                </p>
                            </div>
                        </div>
                    </div>
                            ...
                            <div class="card-body p-4">
                                ...
                                <div class="d-flex mb-4">
                                    ...
                                    <div>
                                        ...
                                        <p class="mb-0">Programas de formación continua y planes de carrera
                                            personalizados</p>
                                    </div>
                                </div>
                                ...
                                <div class="d-flex mb-4">
                                    ...
                                    <div>
                                        ...
                                        <p class="mb-0">Salarios competitivos, bonos por desempeño y beneficios
                                            exclusivos</p>
                                    </div>
                                </div>
                                ...
                                <div class="d-flex mb-4">
                                    ...
                                    <div>
                                        ...
                                        <p class="mb-0">Seguro médico, programas de salud mental y balance vida-trabajo
                                        </p>
                                    </div>
                                </div>
                                ...
                                <div class="d-flex">
                                    ...
                                    <div>
                                        ...
                                        <p class="mb-0">Descuentos en vehículos, servicio gratuito y acceso a nuevos
                                            modelos</p>
                                    </div>
                                </div>
                            </div>
                                ...
                                <form id="cvForm" class="mt-4">
                                    <div class="row g-3">
                                        ...
                                        <div class="col-12">
                                            ...
                                            <input class="form-control" type="file" id="cvFile" accept=".pdf,.doc,.docx"
                                                required>
                                        </div>
                                        <div class="col-12">
