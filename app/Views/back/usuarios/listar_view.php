              ...
              <tr>
                ...
                <td>
                  <?php if (!$consulta['atendida']): ?>
                    <a href="<?= site_url('consultas/marcar_atendida/' . $consulta['id']) ?>"
                       class="btn btn-sm btn-success"
                       onclick="return confirm('¿Marcar esta consulta como atendida?')">
                      <i class="bi bi-check-circle-fill"></i>
                    </a>
                  <?php endif; ?>
                  <a href="<?= site_url('consultas/eliminar/' . $consulta['id']) ?>"
      ...
      <table class="table table-striped table-hover mb-0">
        ...
        <tbody>
          <?php if (!empty($agendas)): ?>
            ...
            <?php endforeach; ?>
          <?php else: ?>
            <tr><td colspan="8" class="text-center text-muted">No hay turnos agendados.</td></tr>
          <?php endif; ?>
        </tbody>
      </table>
    </div>
